...
| <div align="center"><img width="1512" height="819" alt="Image" src="https://github.com/user-attachments/assets/ad615954-c91e-4f5f-ada6-1640b4ae7dc7" /><br><b>손익률 추이</b></div> | <div align="center"><img width="1512" height="819" alt="Image" src="https://github.com/user-attachments/assets/8700f2e6-aa1e-4a26-8d19-1291116bdb99" /><br><b>거래 내역</b></div> |
...
<details>
<summary><b> 📁 BE/backend - Spring Boot 백엔드</b></summary>
<br>

```
BE/backend/
├── 📁 src/main/java/com/hanapath/backend/
│   ├── 📁 account/            # 투자 계좌 관리
│   ├── 📁 attendance/         # 출석 체크
│   ├── 📁 chatbot/            # 챗봇
│   ├── 📁 community/          # 커뮤니티
...
> **Spring Boot 3.x, JPA, Spring Security, JWT, MySQL, MongoDB, Redis**

</details>

<details>
<summary><b> 📁 BE/model - AI 스미싱 탐지 모델</b></summary>
<br>

```
BE/model/
├── smishingmodel.h5               # 스미싱 모델
├── tokenizer.pkl                  # 토크나이저
├── smishing_detection_service.py  # Flask 서버
├── requirements.txt
└── Dockerfile
```

> **TensorFlow, Keras, Flask - 문자 메시지 스미싱 판별**

</details>

<details>
<summary><b> 📁 FE - Next.js 프론트엔드</b></summary>
<br>
...
<details>
<summary><b> 📁 realtime - 실시간 주식 시세</b></summary>
<br>

```
realtime/
├── kis_ws_client.py       # WebSocket 클라이언트
├── kis_chart_api.py       # 차트 API
├── requirements.txt
└── Dockerfile
```

> **한국투자증권 OpenAPI - 실시간 주식 시세**

</details>

<details>
<summary><b> 📁 infrastructure - 인프라 구성</b></summary>
<br>
...
|               | 프로젝트작품(HanaPath) 경진대회 동상 | 한국폴리텍대학 (2025.10.15) |
| **인턴**      | 딥러닝 스타트업 Application Engineer                                         | 2024.09 ~ 2024.12           |           |
